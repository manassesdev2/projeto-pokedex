        ...
        >
          {
            isOpenContact ?
              <>
                ...
                <Flex>
                  <a href='https://github.com/manassesdev2'><Image height='9vh'width='4.8vw' src={github} alt='Github'/></a>
                  <a href='https://www.linkedin.com/in/devmanasses/'><Image height='9vh'width='5vw' src={linkedin} alt='Linkedin'/></a>
                </Flex>
              </>:
              <></>
          }
